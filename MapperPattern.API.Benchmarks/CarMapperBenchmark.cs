...
[RankColumn]
[IterationCount(10)]
public class CarMapperBenchmark
{
    ...
    {
        _carMapper = new CarMapper(new CarFeatureMapper(), new ColorMapper(), new EngineMapper());
    }
    ...
    public void SaveRequestToDomain_CarFeatureListWith1Item()
    {
        ...
        _carMapper.SaveRequestToDomain(carSaveRequest);
    }
    ...
    public void DomainToResponse()
    {
        ...
        _carMapper.DomainToResponse(car);
    }
    ...
    public void DomainToWithRelationshipsResponse_CollectionsWith1Item()
    {
        ...
        _carMapper.DomainToWithRelationshipsResponse(car);
    }
    ...
    public void DomainListToResponseList_With10Items()
    {
        ...
        _carMapper.DomainListToResponseList(carList);
    }
    ...
    public void DomainListToWithRelationshipsList_CollectionsWith1Item_With10Items()
    {
        ...
        _carMapper.DomainListToWithRelationshipsResponseList(carList);
    }
